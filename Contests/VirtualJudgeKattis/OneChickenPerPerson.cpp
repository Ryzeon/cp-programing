// time-limit: 1000
// problem-url: https://vjudge.net/problem/Kattis-onechicken
#include <bits/stdc++.h>
...
void solve() {
  ...
  int cc = m - n;
  if (cc > 0) {
    cout << "Dr. Chaz will have " << abs(cc) << " piece" << (cc > 1 ? "s" : "")
         << " of chicken left over!" << endl;
  } else {
    cout << "Dr. Chaz needs " << abs(cc) << " more piece"
         << (abs(cc) > 1 ? "s" : "") << " of chicken!" << endl;
  }
}
